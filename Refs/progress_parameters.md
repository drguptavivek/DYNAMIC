...
### Percentage of households contacted every 6 months
...
| Expected interval | Roughly every 6 months |
| Numerator | Number of enrolled households successfully contacted during the 6-month monitoring window |
| Denominator | Number of enrolled households expected to be contacted during the 6-month monitoring window |
...
- Household Rounds Form is every 6 calendar months and telephonic as per the forms summary table.
...
1. Define exact 6-month window boundaries.
