...
| Birth Outcome concept boundary               | `docs/superpowers/DataModelConcepts.md`                                                                    | ✅ Done    | documents per-outcome `birth_outcome_id`, multiple outcomes per pregnancy, and live-born HH roster additions |
