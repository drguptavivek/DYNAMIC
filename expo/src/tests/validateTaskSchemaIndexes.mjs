...
const expectedIndexes = [
  ...
  { table: "follow_up_tasks", columns: ["task_key COLLATE NOCASE"] },
  { table: "follow_up_tasks", columns: ["subject_id COLLATE NOCASE"] },
  { table: "follow_up_tasks", columns: ["subject_name COLLATE NOCASE"] },
  { table: "follow_up_tasks", columns: ["task_type COLLATE NOCASE"] },
  { table: "follow_up_tasks", columns: ["protocol_visit_label COLLATE NOCASE"] },
  { table: "follow_up_tasks", columns: ["assigned_locality_code COLLATE NOCASE"] },
